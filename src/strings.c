...
const u8 gText_BlackFlute2[] = _("BBlack Flute");
...
const u8 gText_Pokenav_Cannot_Access_PC[] = _("PC signal cannot reach location.");
...
const u8 gText_ByeByeVar1[] = _("See ya, {STR_VAR_2}!");
